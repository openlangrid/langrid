/*
 * $Id: BackTranslationLanguagePathPanel.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class BackTranslationLanguagePathPanel extends PairLanguagePathPanel{
	/**
	 * 
	 * 
	 */
	public BackTranslationLanguagePathPanel(String componentId){
		super(componentId);
		setSimplexOnly();
	}
