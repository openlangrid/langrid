/*
 * $Id: AtomicServiceTypeDropDownChoice.java 1521 2015-03-10 10:29:09Z t-nakaguchi $
 * 
 ...
 */
package jp.go.nict.langrid.management.web.view.page.language.service.atomic.component.choice;
...
public class AtomicServiceTypeDropDownChoice extends ServiceTypeDropDownChoice{
	 ...
	 */
	public AtomicServiceTypeDropDownChoice(String gridId, String componentId)
	throws ServiceManagerException{
	...
	throws ServiceManagerException
	{
      setServiceTypeList(ServiceFactory.getInstance().getServiceTypeService(gridId).getAtomicServiceTypeList());
