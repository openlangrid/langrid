/*
 * $Id: YourLanguageResourcesEditResultPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class YourLanguageResourcesEditResultPage extends ResourceViewPage{
	/**
	 * 
	 * 
	 */
	public YourLanguageResourcesEditResultPage(String resourceId){
		try {
		   String gridId =  getSelfGridId();
			ResourceModel resource = ServiceFactory.getInstance().getResourceService(gridId).get(resourceId);
