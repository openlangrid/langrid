/*
 * $Id: NewsLogOutPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class NewsLogOutPage extends NewsPage {
//	@Override
//	protected Panel getTabPanel(String gridId, String panelId, GridRelation relation)  throws ServiceManagerException {
//		NewsSortableDataProvider provider = new NewsSortableDataProvider(gridId, getSessionUserId());
//		provider.setConditions(new MatchingCondition[]{}, new Order[]{}, Scope.ALL);
//		NewsListPanel panel = new NewsListPanel(gridId, panelId, provider, relation) {
//			@Override
