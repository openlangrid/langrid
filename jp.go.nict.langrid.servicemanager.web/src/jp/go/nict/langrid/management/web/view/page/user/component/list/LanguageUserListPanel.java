/*
 * $Id: LanguageUserListPanel.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
...
import jp.go.nict.langrid.management.web.view.page.user.component.list.row.LanguageUsersListRowPanel;
import jp.go.nict.langrid.management.web.view.page.user.component.list.row.UserListHeaderPanel;
 ...
 */
public class LanguageUserListPanel extends AbstractListPanel<UserModel>{
	/**
	 * 
	 * 
	 */
	public LanguageUserListPanel(String gridId
			, String componentId, IDataProvider<UserModel> dataProvider)
	{
		super(gridId, componentId, dataProvider);
	}
	
	@Override
	final protected void addListItem(String gridId, String rowId, Item<UserModel> item){
		Panel row;
		try{
	...
	protected Panel getHeaderPanel(){
		return new UserListHeaderPanel("header");
	}
	...
	throws ServiceManagerException{
		return  new LanguageUsersListRowPanel(gridId, "row", item.getModelObject(), uniqueId);
	}
