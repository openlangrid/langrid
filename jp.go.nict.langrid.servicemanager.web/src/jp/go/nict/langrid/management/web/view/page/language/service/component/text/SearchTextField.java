/*
 * $Id: SearchTextField.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
...
public class SearchTextField extends TextField<String>{
	 ...
	 * 
	 */
	public SearchTextField(String componentId){
	 ...
	 * 
	 */
	public SearchTextField(String componentId, IModel<String>model){
		super(componentId, model);
		addValidater();
	}

	private void addValidater(){
		add(new LengthValidator(0, 254, "ProvidingServices.language.service.error.ServiceID"));
	}
