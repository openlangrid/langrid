/*
 * $Id: ProtocolsOfServiceAdminPage.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
...
import jp.go.nict.langrid.management.web.view.page.language.service.admin.protocol.component.list.ProtocolListAdminPanel;
 ...
 */
public class ProtocolsOfServiceAdminPage extends ServiceManagerPage {
   public ProtocolsOfServiceAdminPage() {
      try {
	...
	protected Panel getListPanel(String gridId, ProtocolSortableDataProvider provider){
	   return new ProtocolListAdminPanel(gridId, "protocolListPanel", provider){
         @Override
         protected void deleteProcess(String id) {
            try {
               ServiceFactory.getInstance().getProtocolService(getSelfGridId()).deleteById(id);
            } catch(ServiceManagerException e) {
               doErrorProcess(e);
            }
         }
	...
	protected void setRegistrationPage(){
	   setResponsePage(new RegistrationOfServiceProtocolPage());
	}
}
