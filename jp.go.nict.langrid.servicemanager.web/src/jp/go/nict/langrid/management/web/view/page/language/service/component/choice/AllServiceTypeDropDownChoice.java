 ...
 */
public class AllServiceTypeDropDownChoice extends DropDownChoice<ServiceTypeModel> {
	/**
	 * 
	 * 
	 * @throws ServiceManagerException 
	 */
	public AllServiceTypeDropDownChoice(String gridId, String componentId)
	throws ServiceManagerException {
		super(componentId
	...
	public AllServiceTypeDropDownChoice(String gridId, String domainId, String componentId)
	throws ServiceManagerException {
		super(componentId
				, new Model<ServiceTypeModel>()
				, new WildcardListModel<ServiceTypeModel>());
