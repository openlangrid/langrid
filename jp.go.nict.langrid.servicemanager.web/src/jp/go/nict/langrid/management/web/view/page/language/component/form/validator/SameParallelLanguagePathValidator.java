/*
 * $Id: SameParallelLanguagePathValidator.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class SameParallelLanguagePathValidator extends AbstractFormValidator{
	/**
	 * 
	 * 
	 */
	public SameParallelLanguagePathValidator(RepeatingLanguagePathPanel repeater){
			...
			for(int i = 0; i < inputs.length; i++){
				...
				if(tmp.contains(inputs[i])){
					form.error(MessageManager.getMessage(
							"SameParallelLanguagePathValidator", Locale.ENGLISH));
					return;
				}
				tmp.add(inputs[i]);
			}
