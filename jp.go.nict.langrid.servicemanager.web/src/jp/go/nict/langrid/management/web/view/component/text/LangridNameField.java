/*
 * $Id: LangridNameField.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class LangridNameField extends RequiredTextField<String>{
	/**
	 * 
	 * 
	 */
	public LangridNameField(String componentId){
	 ...
	 * 
	 */
	public LangridNameField(String componentId, IModel<String> model){
