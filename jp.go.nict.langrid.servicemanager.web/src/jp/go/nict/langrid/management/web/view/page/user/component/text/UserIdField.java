/*
 * $Id: UserIdField.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class UserIdField extends TextField<String>{
	/**
	 * 
	 * 
	 */
	public UserIdField(String componentId){
	 ...
	 * 
	 */
	public UserIdField(String componentId, Model<String> model){
	 ...
	 * 
	 */
	public UserIdField(String componentId, IModel<String> model){
		super(componentId, model);
		add(new LengthValidator(4, 254, "LanguageGridOperator.error.validate.format.Id"));
		add(new HalfSizeAlphaNumeralSiglumValidator("LanguageGridOperator.error.validate.format.Id"));
	}
