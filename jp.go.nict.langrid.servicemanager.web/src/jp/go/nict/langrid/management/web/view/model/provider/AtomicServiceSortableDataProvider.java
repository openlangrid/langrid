/*
 * $Id: AtomicServiceSortableDataProvider.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
 ...
 */
public class AtomicServiceSortableDataProvider
extends LangridSortableDataProvider<AtomicServiceModel> {
	/**
	 * 
	 * 
	 */
	public AtomicServiceSortableDataProvider(String serviceGridId, String userGridId, String userId)
	...
	protected MatchingCondition[] getConditions() {
		...
		list.add(new MatchingCondition("containerType", ServiceContainerType.ATOMIC));
		return list.toArray(new MatchingCondition[]{});
	}

	@Override
	protected DataService<AtomicServiceModel> getService() throws ServiceManagerException {
		return ServiceFactory.getInstance().getAtomicServiceService(serviceGridId, userGridId, userId);
	}
