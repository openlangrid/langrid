/*
 * $Id: RegistrationResultPage.java 328 2010-12-08 05:43:18Z t-nakaguchi $
 *
 ...
 */
public class RegistrationResultPage extends ServiceManagerPage {
	/**
	 * 
	 * 
	 */
	public RegistrationResultPage(String domainId, String id) {
		try {
			ResourceTypeModel model = ServiceFactory.getInstance().getResourceTypeService(
				getSelfGridId()).get(domainId, id);
			String domainName = ServiceFactory.getInstance().getDomainService(
				getSelfGridId()).get(model.getDomainId()).getDomainName();
