/*
 * $Id: EditOfServiceProtocolResultPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 *
 ...
 */
public class EditOfServiceProtocolResultPage extends ServiceManagerPage{
	/**
	 * 
	 * 
	 */
	public EditOfServiceProtocolResultPage(String id, String name, String description){
	   add(new Label("id", id));
