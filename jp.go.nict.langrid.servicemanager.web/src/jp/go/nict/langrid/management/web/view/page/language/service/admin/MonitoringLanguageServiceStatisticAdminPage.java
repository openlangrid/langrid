/*
 * $Id: MonitoringLanguageServiceStatisticAdminPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class MonitoringLanguageServiceStatisticAdminPage
extends MonitoringLanguageServiceStatisticPage
{
	 ...
	 * 
	 */
	public MonitoringLanguageServiceStatisticAdminPage(
	...
	protected Page getBackPage(){
		return new MonitoringLanguageServiceAdminPage();
	}
	
	@Override
	protected MonitoringUserListPanel getTabPanel(
	   String panelId, String serviceGridId, String serviceId, String userGridId, Calendar start, Calendar end)
	throws ServiceManagerException
	{
		AccessStatisticsSortableDataProvider dp = new AccessStatisticsSortableDataProvider(
			serviceGridId, serviceId, userGridId, getSessionUserId(), CalendarUtil.createBeginningOfDay(start)
			...
			throws ServiceManagerException {
				return new MonitoringUserListRowPanel("row", item.getModelObject(), uniqueId)
				{
					...
					protected Page getVerboseMonitoringPage(ExecutionInformationStatisticsModel uEntry){
						return new MonitoringLanguageServiceVerboseAdminPage(
								uEntry, getStart(), getEnd(), 0);
					}
