/*
 * $Id: URLField.java 497 2012-05-24 04:13:03Z t-nakaguchi $
 * 
...
public class URLField extends TextField<String>{
	public URLField(String componentId) {
		super(componentId);
...
//		add(new UrlValidator());
	 ...
	 * 
	 */
	public URLField(String componentId, Model<String> model){
...
//		add(new UrlValidator());
	 ...
	 * 
	 */
	public URLField(String componentId, IModel<String> model){
		super(componentId, model);
		add(new URLValidator());
//		add(new UrlValidator());
	}
