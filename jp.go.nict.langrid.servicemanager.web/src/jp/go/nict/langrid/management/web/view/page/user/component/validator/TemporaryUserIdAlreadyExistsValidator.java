/*
 * $Id: TemporaryUserIdAlreadyExistsValidator.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class TemporaryUserIdAlreadyExistsValidator implements IValidator<String>{
	/**
	 * 
	 * 
	 */
	public TemporaryUserIdAlreadyExistsValidator(String gridId, Component component){
	...
	public void validate(IValidatable<String> validatable){
		try{
			...
			ServiceManagerSession session = (ServiceManagerSession)component.getSession();
			TemporaryUserModel entry = ServiceFactory.getInstance().getTemporaryUserService(gridId).get(userId);
			if(entry != null){
