/*
 * $Id: RegistrationOfLanguageResourceUserListPage.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
...
import jp.go.nict.langrid.management.web.view.page.user.component.list.row.RegistrationOfLanguageResourecUserListAdminRowPanel;
 ...
 */
public class RegistrationOfLanguageResourceUserListPage extends ServiceManagerPage {
	/**
	 * 
	 * 
	 */
	public RegistrationOfLanguageResourceUserListPage(){
		try {
			...
			add(new LanguageUserListPanel(getSelfGridId(), "userListPanel", dp){
				...
				throws ServiceManagerException{
					return new RegistrationOfLanguageResourecUserListAdminRowPanel(
