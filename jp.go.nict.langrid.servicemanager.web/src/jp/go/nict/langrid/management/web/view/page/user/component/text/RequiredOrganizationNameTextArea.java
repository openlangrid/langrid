/*
 * $Id: RequiredOrganizationNameTextArea.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class RequiredOrganizationNameTextArea extends RequiredTextArea{
	/**
	 * 
	 * 
	 */
	public RequiredOrganizationNameTextArea(String componentId, IModel<String> model){
		super(componentId, model);
		add(new HalfSizeAlphaNumeralSiglumSpaceValidator());
		add(StringValidator.lengthBetween(0, 254));
	}
