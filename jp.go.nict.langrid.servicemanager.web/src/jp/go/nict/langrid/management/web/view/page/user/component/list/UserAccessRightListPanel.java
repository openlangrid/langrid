/*
 * $Id: UserAccessRightListPanel.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
...
import jp.go.nict.langrid.management.web.view.page.user.component.list.row.UserAccessRightListHeaderPanel;
 ...
 */
public abstract class UserAccessRightListPanel
extends AbstractListPanel<AccessRightControlModel>
{
	/**
	 * 
	 * 
	 */
	public UserAccessRightListPanel(String componentId, String gridId
			, IDataProvider<AccessRightControlModel> provider)
	{
		super(gridId, componentId, provider);
	}

	@Override
	protected void addListItem(String gridId, String rowId, Item<AccessRightControlModel> item){
		try{
	...
	protected Panel getHeaderPanel(){
		return new UserAccessRightListHeaderPanel("header");
	}
