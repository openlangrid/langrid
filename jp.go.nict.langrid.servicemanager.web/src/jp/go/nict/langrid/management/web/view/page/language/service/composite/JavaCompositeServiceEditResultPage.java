/*
 * $Id: JavaImplemenationCompositeServiceEditResultPage.java
 *
 ...
 * @version $ $
 */
public class JavaCompositeServiceEditResultPage extends ServiceViewPage {
	/**
	 * 
	 * 
	 */
	public JavaCompositeServiceEditResultPage(String serviceId) {
		JarFile jf = null;
		try{
			...
			JavaCompositeServiceModel model = 
				(JavaCompositeServiceModel)service.get(serviceId);
			...
			if(jf != null){
				try{
					...
					LogWriter.writeOutOfSystemError("System", e, getClass(), "Can't delete zip file, \"" + jf.getName() + "\"");
				}
			}
		}
	}
