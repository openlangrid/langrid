 ...
 */
public class DomainDropDownChoice extends DropDownChoice<DomainModel> {
	/**
	 * 
	 * 
	 */
	public DomainDropDownChoice(String gridId, String componentId)
	throws ServiceManagerException {
		...
		list = ServiceFactory.getInstance().getDomainService(gridId).getList(
