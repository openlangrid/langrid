/*
 * $Id: ArrayElementValidator.java 872 2013-04-29 09:29:55Z t-nakaguchi $
 * 
 ...
 */
public class ArrayElementValidator
implements ValidatorImpl<Annotation, Object>{
	/**
	 * 
	 * 
	 */
	public void validate(Annotation annotation, Object array)
		...
		try{
			...
			AnnotationValidationExecutor.executeForArray(
					clazz, annot, array
					);
