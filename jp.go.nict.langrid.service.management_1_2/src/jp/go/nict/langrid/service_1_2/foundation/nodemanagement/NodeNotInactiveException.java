/*
 * $Id: NodeNotInactiveException.java 225 2010-10-03 00:23:14Z t-nakaguchi $
 *
 ...
 */
public class NodeNotInactiveException
extends LangridException
{
	 ...
	 * @param nodeId ノードID
	 */
	public NodeNotInactiveException(String nodeId){
		super("node \"" + nodeId + "\"" + "is no inactive.");
		this.nodeId = nodeId;
	}
