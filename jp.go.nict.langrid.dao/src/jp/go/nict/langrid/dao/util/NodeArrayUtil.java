...
import jp.go.nict.langrid.dao.transformer.NodeToNodeIdTransformer;
 ...
 */
public class NodeArrayUtil {
	/**
	 * 
	 * 
	 */
	public static String[] collectNodeId(Node[] nodes){
		return ArrayUtil.collect(
				nodes, new NodeToNodeIdTransformer()
				);
	}
}
