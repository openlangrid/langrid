/*
 * $Id: ServiceUtil.java 214 2010-10-02 14:32:38Z t-nakaguchi $
 *
...
extends EntityUtil
{
	...
	static{
		...
		addProperties(Service.class, props);
		addProperties(ExternalService.class, props);
		addProperties(BPELService.class, props);
