...
public class ResourceNotFoundException extends DaoException{
	 ...
	 * 
	 */
	public ResourceNotFoundException(String resourceGridId, String resourceId, Throwable cause){
	...
	private static String toMessage(String resourceGridId, String resourceId){
		return "language resource (id:" + resourceId + ",gridId:" + resourceGridId + ") is not found in repository.";
	}

	private static final long serialVersionUID = 1828173022428830501L;
}
