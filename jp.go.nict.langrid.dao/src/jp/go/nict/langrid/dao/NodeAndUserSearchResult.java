 ...
 */
public class NodeAndUserSearchResult
extends SearchResult
{
	 ...
	 * 
	 */
	public NodeAndUserSearchResult(
			Pair<Node, User>[] elements
			, int totalCount
	 ...
	 * 
	 */
	public Pair<Node, User>[] getElements(){
		return elements;
	}

	private Pair<Node, User>[] elements;
}
