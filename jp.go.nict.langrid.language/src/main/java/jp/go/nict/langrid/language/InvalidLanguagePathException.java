/*
 * $Id: InvalidLanguagePathException.java 217 2010-10-02 14:45:56Z t-nakaguchi $
 *
...
public class InvalidLanguagePathException extends Exception {
	 ...
	 * 
	 */
	public InvalidLanguagePathException(String message) {
		super(message);
	}
	 ...
	 * 
	 */
	public InvalidLanguagePathException(Throwable cause){
		super(cause);
	}
