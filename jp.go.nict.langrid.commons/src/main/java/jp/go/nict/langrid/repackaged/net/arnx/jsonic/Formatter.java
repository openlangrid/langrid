...
import jp.go.nict.langrid.repackaged.net.arnx.jsonic.JSON.Context;
import jp.go.nict.langrid.repackaged.net.arnx.jsonic.JSON.Mode;
		...
		for (int p = 0; p < length; p++) {
			...
			try {
				...
				if (value == src || (context.isSuppressNull() && value == null))
					continue;
				if (context.isSuppressEmptyArray() && value != null){
