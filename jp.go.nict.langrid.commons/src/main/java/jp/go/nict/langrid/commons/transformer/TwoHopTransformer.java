/*
 * $Id: TwoHopTransformer.java 182 2010-10-02 03:16:36Z t-nakaguchi $
 *
...
implements Transformer<T, V>{
	 ...
	 * 
	 */
	public TwoHopTransformer(
			Transformer<T, U> firstTransformer
	...
	public V transform(T value) throws TransformationException {
		return secondTransformer.transform(
				firstTransformer.transform(value)
				);
	}
