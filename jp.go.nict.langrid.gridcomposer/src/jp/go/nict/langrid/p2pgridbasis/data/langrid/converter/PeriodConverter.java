/*
 * $Id: PeriodConverter.java 318 2010-12-03 03:10:29Z t-nakaguchi $
 *
...
public class PeriodConverter implements Converter {
	static private Logger logger = Logger.getLogger(PeriodConverter.class);
	...
	public Object convert(Class type, Object value) {
		if (value == null) {
			...
			logger.debug(Period.valueOf(value.toString()));
