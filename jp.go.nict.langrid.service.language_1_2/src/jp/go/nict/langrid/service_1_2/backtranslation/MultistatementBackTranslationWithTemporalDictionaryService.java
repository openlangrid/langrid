/*
 * $Id: MultistatementBackTranslationWithTemporalDictionaryService.java 587 2012-10-19 06:41:14Z t-nakaguchi $
 *
 ...
 */
@Service(namespace="servicegrid:servicetype:nict.nlp:MultistatementBackTranslationWithTemporalDictionary")
public interface MultistatementBackTranslationWithTemporalDictionaryService {
	/**
	 * 
	 * Run translation.
	 * @param sourceLang Translation source language (RFC3066 compliant)
	 * @param intermediateLang Target language of the translation (RFC3066 compliant)
	 ...
	 * 
	 */
	BackTranslationResult[] multistatementBackTranslate(
