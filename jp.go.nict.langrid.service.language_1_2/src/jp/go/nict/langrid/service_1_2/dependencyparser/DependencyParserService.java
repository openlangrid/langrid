/*
 * $Id: DependencyParserService.java 903 2013-07-12 04:29:01Z t-nakaguchi $
 *
 ...
 */
@Service(namespace="servicegrid:servicetype:nict.nlp:DependencyParser")
public interface DependencyParserService{
	...
	Chunk[] parseDependency(
			...
			, @Parameter(name="sentence") String sentence)
