/*
 * $Id: MultilingualTranslationWithTemporalDictionaryService.java 567 2012-08-06 11:37:14Z t-nakaguchi $
 *
 ...
 */
public interface MultilingualTranslationWithTemporalDictionaryService {
	/**
	 * 
	 * Run translation.
	 * @param sourceLang Translation source language (RFC3066 compliant)
	 * @param targetLangs Target languages of the translation (RFC3066 compliant)
	 * @param source String to be translated
	 * @param temporalDict Bilingual dictionary data used during translation
	 * @param dictTargetLangs Target languages of dictionary data(targetLang)
	...
	String translate(
			...
			, @Parameter(name="targetLang") String[] targetLangs
			, @Parameter(name="source") String source
			, @Parameter(name="temporalDict") Translation[] temporalDict
			, @Parameter(name="dictTargetLangs") String[] dictTargetLangs)
