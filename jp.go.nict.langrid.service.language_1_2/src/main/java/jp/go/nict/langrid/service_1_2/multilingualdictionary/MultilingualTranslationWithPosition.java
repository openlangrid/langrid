 ...
 */
package jp.go.nict.langrid.service_1_2.multilingualdictionary;
 ...
 */
@Schema(namespace="http://langrid.nict.go.jp/ws_1_2/multilingualdictionary/")
public class MultilingualTranslationWithPosition implements Serializable{
	/**
	 * 
	 * Constructor.
	 * 
	 */
	public MultilingualTranslationWithPosition(){}
	 ...
	 * 
	 */
	public MultilingualTranslationWithPosition(MultilingualTranslation translation, int startIndex,
	 ...
	 * 
	 */
	public MultilingualTranslation getTranslation(){
		return translation;
	}
	 ...
	 * 
	 */
	public void setTranslation(MultilingualTranslation translation){
		this.translation = translation;
	}
	...
	@Field(order=3)
	private MultilingualTranslation translation;
