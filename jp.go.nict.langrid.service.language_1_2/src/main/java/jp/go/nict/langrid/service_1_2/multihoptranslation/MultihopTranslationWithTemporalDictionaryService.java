/*
 * $Id: MultihopTranslationWithTemporalDictionaryService.java 1375 2015-01-03 11:34:58Z t-nakaguchi $
 *
...
public interface MultihopTranslationWithTemporalDictionaryService {
	 ...
	 * @param temporalDicts Bilingual dictionaries data used during translation
	...
	MultihopTranslationResult multihopTranslate(
			...
			, @Parameter(name="intermediateDictTargets") String[][][] intermediateDictTargets
			, @Parameter(name="intermediateDictTargetLangs") String[] intermediateDictTargetLangs)
