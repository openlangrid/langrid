/*
 * $Id: ParallelTextWithEmbeddedMetadataService.java 567 2012-08-06 11:37:14Z t-nakaguchi $
 *
...
public interface ParallelTextWithEmbeddedMetadataService {
	...
	ParallelTextWithMetadata[] searchParallelTextsByMetadata(
			...
			, @Parameter(name="metadata") String[] metadata
	 ...
	 * 
	 */
	String[] searchSupportedMetadata(
