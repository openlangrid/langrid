...
public class MorphologicalAnalysisProtosUtil {
	public static AnalyzeRequest buildAnalyzeRequest(
			List<Header> headers, String language, String text){
		return AnalyzeRequest.newBuilder()
