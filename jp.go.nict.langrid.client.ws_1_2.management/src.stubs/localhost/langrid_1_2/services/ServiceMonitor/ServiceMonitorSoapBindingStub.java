/**
 * ServiceMonitorSoapBindingStub.java
 *
...
public class ServiceMonitorSoapBindingStub extends org.apache.axis.client.Stub implements localhost.langrid_1_2.services.ServiceMonitor.ServiceMonitor {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "fault"),
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "orders"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "ArrayOf_tns2_Order"), jp.go.nict.langrid.ws_1_2.foundation.Order[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "AccessLogSearchResult"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLogSearchResult.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "searchAccessLogsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "fault"),
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("getAccessCounts");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "userId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "serviceId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "baseDateTime"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"), java.util.Calendar.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "ArrayOf_xsd_int"));
        oper.setReturnClass(int[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getAccessCountsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "fault"),
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "orders"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "ArrayOf_tns2_Order"), jp.go.nict.langrid.ws_1_2.foundation.Order[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "UserAccessEntrySearchResult"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntrySearchResult.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "sumUpUserAccessReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "fault"),
    ...
    public ServiceMonitorSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ServiceMonitorSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ServiceMonitorSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "AccessLog");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLog.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "AccessLogSearchResult");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLogSearchResult.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "UserAccessEntry");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntry.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "UserAccessEntrySearchResult");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntrySearchResult.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "ArrayOf_tns2_Order");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.Order[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/", "Order");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "ArrayOf_tns3_AccessLog");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLog[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "AccessLog");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "ArrayOf_tns3_UserAccessEntry");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntry[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemonitor/", "UserAccessEntry");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/ServiceMonitor", "ArrayOf_xsd_int");
            cachedSerQNames.add(qName);
            cls = int[].class;
            cachedSerClasses.add(cls);
    ...
    public void clear() throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.UnknownException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ServiceConfigurationException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicemonitor.foundation.langrid.nict.go.jp", "clear"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLogSearchResult searchAccessLogs(int startIndex, int maxCount, java.lang.String userId, java.lang.String serviceId, java.util.Calendar startDateTime, java.util.Calendar endDateTime, jp.go.nict.langrid.ws_1_2.foundation.Order[] orders) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.UnknownException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ServiceConfigurationException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicemonitor.foundation.langrid.nict.go.jp", "searchAccessLogs"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(startIndex), new java.lang.Integer(maxCount), userId, serviceId, startDateTime, endDateTime, orders});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLogSearchResult) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLogSearchResult) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.AccessLogSearchResult.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
  ...
  throw axisFaultException;
    ...
    public int[] getAccessCounts(java.lang.String userId, java.lang.String serviceId, java.util.Calendar baseDateTime, java.lang.String period) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.UnknownException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ServiceConfigurationException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicemonitor.foundation.langrid.nict.go.jp", "getAccessCounts"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {userId, serviceId, baseDateTime, period});
  ...
  throw axisFaultException;
    ...
    public jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntrySearchResult sumUpUserAccess(int startIndex, int maxCount, java.lang.String serviceId, java.util.Calendar startDateTime, java.util.Calendar endDateTime, java.lang.String period, jp.go.nict.langrid.ws_1_2.foundation.Order[] orders) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.UnknownException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ServiceConfigurationException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicemonitor.foundation.langrid.nict.go.jp", "sumUpUserAccess"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Integer(startIndex), new java.lang.Integer(maxCount), serviceId, startDateTime, endDateTime, period, orders});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntrySearchResult) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntrySearchResult) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.foundation.servicemonitor.UserAccessEntrySearchResult.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
