/**
 * BPELServiceManagementSoapBindingStub.java
 *
...
public class BPELServiceManagementSoapBindingStub extends org.apache.axis.client.Stub implements localhost.langrid_1_2.services.BPELServiceManagement.BPELServiceManagement {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("listPartnerNamespaces");
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/BPELServiceManagement", "ArrayOf_xsd_string"));
        oper.setReturnClass(java.lang.String[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "listPartnerNamespacesReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/BPELServiceManagement", "fault"),
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("listPartnerServices");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "serviceId"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/BPELServiceManagement", "ArrayOf_tns2_ServiceEntry"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.foundation.servicemanagement.ServiceEntry[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "listPartnerServicesReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/BPELServiceManagement", "fault"),
    ...
    public BPELServiceManagementSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BPELServiceManagementSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BPELServiceManagementSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/BPELServiceManagement", "ArrayOf_tns1_LanguagePath");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.LanguagePath[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/", "LanguagePath");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/BPELServiceManagement", "ArrayOf_tns2_ServiceEntry");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.foundation.servicemanagement.ServiceEntry[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/foundation/servicemanagement", "ServiceEntry");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/langrid-1.2/services/BPELServiceManagement", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public java.lang.String[] listPartnerNamespaces(java.lang.String serviceId) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.UnknownException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ServiceConfigurationException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicemanagement.foundation.langrid.nict.go.jp", "listPartnerNamespaces"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {serviceId});
  ...
  throw axisFaultException;
    ...
    public jp.go.nict.langrid.ws_1_2.foundation.servicemanagement.ServiceEntry[] listPartnerServices(java.lang.String serviceId) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.UnknownException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ServiceConfigurationException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://servicemanagement.foundation.langrid.nict.go.jp", "listPartnerServices"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {serviceId});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (jp.go.nict.langrid.ws_1_2.foundation.servicemanagement.ServiceEntry[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.foundation.servicemanagement.ServiceEntry[]) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.foundation.servicemanagement.ServiceEntry[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
