/**
 * DependencyParserSoapBindingStub.java
 *
...
public class DependencyParserSoapBindingStub extends org.apache.axis.client.Stub implements localhost.wrapper_mock_1_2_N.services.DependencyParser.DependencyParser {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/DependencyParser", "ArrayOf_tns1_Chunk"));
        ...
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/DependencyParser", "fault"),
    ...
    public DependencyParserSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public DependencyParserSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public DependencyParserSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/DependencyParser", "ArrayOf_tns1_Chunk");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/dependencyparser/", "Chunk");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/DependencyParser", "ArrayOf_tns2_Morpheme");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/morphologicalanalysis/", "Morpheme");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/DependencyParser", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[] parseDependency(java.lang.String language, java.lang.String sentence) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.LanguageNotUniquelyDecidedException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.NoValidEndpointsException, jp.go.nict.langrid.ws_1_2.ServiceNotActiveException, jp.go.nict.langrid.ws_1_2.UnsupportedLanguageException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.ServerBusyException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ProcessFailedException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://dependencyparser.ws_1_2.wrapper.langrid.nict.go.jp", "parseDependency"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {language, sentence});
