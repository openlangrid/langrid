/**
 * TranslationSelectionSoapBindingStub.java
 *
...
public class TranslationSelectionSoapBindingStub extends org.apache.axis.client.Stub implements localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.TranslationSelectionService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.atomic/services/TranslationSelection", "SelectionResult"));
        oper.setReturnClass(localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.SelectionResult.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "selectReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.atomic/services/TranslationSelection", "fault"),
    ...
    public TranslationSelectionSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public TranslationSelectionSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public TranslationSelectionSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.atomic/services/TranslationSelection", "ArrayOf_tns1_LanguagePath");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.LanguagePath[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/", "LanguagePath");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.atomic/services/TranslationSelection", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.atomic/services/TranslationSelection", "ArrayOfEstimationResult");
            cachedSerQNames.add(qName);
            cls = localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.EstimationResult[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.atomic/services/TranslationSelection", "EstimationResult");
            qName2 = null;
            cachedSerFactories.add(new org.apache.axis.encoding.ser.ArraySerializerFactory(qName, qName2));
            cachedDeserFactories.add(new org.apache.axis.encoding.ser.ArrayDeserializerFactory());
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.atomic/services/TranslationSelection", "SelectionResult");
            cachedSerQNames.add(qName);
            cls = localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.SelectionResult.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.SelectionResult select(java.lang.String in0, java.lang.String in1, java.lang.String in2) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.UnsupportedLanguagePairException, jp.go.nict.langrid.ws_1_2.LanguagePairNotUniquelyDecidedException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.ProcessFailedException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://translationselection.service_1_2.langrid.nict.go.jp", "select"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {in0, in1, in2});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.SelectionResult) _resp;
            } catch (java.lang.Exception _exception) {
                return (localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.SelectionResult) org.apache.axis.utils.JavaUtils.convert(_resp, localhost.jp_go_nict_langrid_webapps_atomic.services.TranslationSelection.SelectionResult.class);
            }
        }
