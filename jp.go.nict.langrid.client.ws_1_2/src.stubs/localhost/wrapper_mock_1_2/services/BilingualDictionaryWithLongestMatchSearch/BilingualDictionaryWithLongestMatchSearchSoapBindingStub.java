/**
 * BilingualDictionaryWithLongestMatchSearchSoapBindingStub.java
 *
...
public class BilingualDictionaryWithLongestMatchSearchSoapBindingStub extends org.apache.axis.client.Stub implements localhost.wrapper_mock_1_2.services.BilingualDictionaryWithLongestMatchSearch.BilingualDictionaryWithLongestMatchSearch {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_xsd_string"));
        oper.setReturnClass(java.lang.String[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "getSupportedMatchingMethodsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "fault"),
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns1_LanguagePair"));
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("searchLongestMatchingTerms");
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "morpheme"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns2_Morpheme"), jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns3_TranslationWithPosition"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.bilingualdictionary.TranslationWithPosition[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "searchLongestMatchingTermsReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "fault"),
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns3_Translation"));
    ...
    public BilingualDictionaryWithLongestMatchSearchSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BilingualDictionaryWithLongestMatchSearchSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BilingualDictionaryWithLongestMatchSearchSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/bilingualdictionary/", "TranslationWithPosition");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.bilingualdictionary.TranslationWithPosition.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/morphologicalanalysis/", "Morpheme");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns1_LanguagePair");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.LanguagePair[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/", "LanguagePair");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns2_Morpheme");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/morphologicalanalysis/", "Morpheme");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns3_Translation");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.bilingualdictionary.Translation[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/bilingualdictionary/", "Translation");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_tns3_TranslationWithPosition");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.bilingualdictionary.TranslationWithPosition[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/bilingualdictionary/", "TranslationWithPosition");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/BilingualDictionaryWithLongestMatchSearch", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public jp.go.nict.langrid.ws_1_2.bilingualdictionary.TranslationWithPosition[] searchLongestMatchingTerms(java.lang.String headLang, java.lang.String targetLang, jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[] morpheme) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.UnsupportedLanguagePairException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.LanguagePairNotUniquelyDecidedException, jp.go.nict.langrid.ws_1_2.NoValidEndpointsException, jp.go.nict.langrid.ws_1_2.ServiceNotActiveException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.ServerBusyException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ProcessFailedException, jp.go.nict.langrid.ws_1_2.UnsupportedMatchingMethodException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://bilingualdictionary.ws_1_2.wrapper.langrid.nict.go.jp", "searchLongestMatchingTerms"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {headLang, targetLang, morpheme});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (jp.go.nict.langrid.ws_1_2.bilingualdictionary.TranslationWithPosition[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.bilingualdictionary.TranslationWithPosition[]) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.bilingualdictionary.TranslationWithPosition[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {headLang, targetLang, headWord, matchingMethod});
  ...
  throw axisFaultException;
    ...
    public java.util.Calendar getLastUpdate() throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.NoValidEndpointsException, jp.go.nict.langrid.ws_1_2.ServiceNotActiveException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.ServerBusyException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ProcessFailedException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://ws_1_2.wrapper.langrid.nict.go.jp", "getLastUpdate"));
