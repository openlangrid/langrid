 ...
 */
package jp.go.nict.langrid.client.impl.axis;
...
public class AxisStubUtil {
	...
	static{
		...
		registerStub(MultihopTranslationWithTemporalDictionaryService.class, new MultihopTranslationWithTemporalDictionaryServiceServiceLocator(), "getMultihopTranslationWithTemporalDictionary");
