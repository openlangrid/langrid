/**
 * AdjacencyPairSoapBindingStub.java
 *
...
public class AdjacencyPairSoapBindingStub extends org.apache.axis.client.Stub implements localhost.wrapper_mock_1_2_N.services.AdjacencyPair.AdjacencyPair {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "firstTurn"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/AdjacencyPair", "ArrayOf_tns1_AdjacencyPair"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.adjacencypair.AdjacencyPair[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "searchReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/AdjacencyPair", "fault"),
    ...
    public AdjacencyPairSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public AdjacencyPairSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public AdjacencyPairSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/adjacencypair/", "AdjacencyPair");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.adjacencypair.AdjacencyPair.class;
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/AdjacencyPair", "ArrayOf_tns1_AdjacencyPair");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.adjacencypair.AdjacencyPair[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/adjacencypair/", "AdjacencyPair");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2.N/services/AdjacencyPair", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public jp.go.nict.langrid.ws_1_2.adjacencypair.AdjacencyPair[] search(java.lang.String category, java.lang.String language, java.lang.String firstTurn, java.lang.String matchingMethod) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.LanguageNotUniquelyDecidedException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.NoValidEndpointsException, jp.go.nict.langrid.ws_1_2.ServiceNotActiveException, jp.go.nict.langrid.ws_1_2.UnsupportedLanguageException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.ServerBusyException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ProcessFailedException, jp.go.nict.langrid.ws_1_2.UnsupportedMatchingMethodException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://adjacencypair.ws_1_2.wrapper.langrid.nict.go.jp", "search"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {category, language, firstTurn, matchingMethod});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (jp.go.nict.langrid.ws_1_2.adjacencypair.AdjacencyPair[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.adjacencypair.AdjacencyPair[]) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.adjacencypair.AdjacencyPair[].class);
            }
        }
