/*
 * $Id: HangulAnalysis.java 409 2011-08-25 03:12:59Z t-nakaguchi $
 *
...
public class HangulAnalysis implements Analysis {
	...
	public String doConstructSource(Morpheme[] morphemes) {
		...
		if ((end == '。' || end == '.' || end == '．') && source.length() > 1) {
	 ...
	 * @return
	 */
	public SourceAndMorphemesAndCodes doConstructSMC(Morpheme[] morphemes,
