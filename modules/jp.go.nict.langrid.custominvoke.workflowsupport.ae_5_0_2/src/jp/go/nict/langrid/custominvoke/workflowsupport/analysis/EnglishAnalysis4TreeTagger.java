...
//					else if (str.equals(";")) {
//						// エスケープシーケンス対策 start
//						String word  = morphemes[i].getWord();
//						if (word != null && 
//								(str.indexOf("&#39") > -1 || word.indexOf("&quot") > -1 || word.indexOf("&nbsp") > -1 || str.indexOf("&amp") > -1)) {
//							String nextStr = null;
//							if ((i + 1) < length) {
//								nextStr = morphemes[i + 1].getWord();
//							}
//							if (nextStr == null) {
//								continue;
//							}
//							if (nextStr.equals(";")) {
//								i++;
//								String tmpStr = word + nextStr;
//								if (ESCAPE_SENTENCE.containsKey(tmpStr)) {
//									String value = ESCAPE_SENTENCE.get(tmpStr);
//									morphemeResult.remove(morphemeResult.size() - 1);
//									morphemeResult.add(new Morpheme(value, value, PartOfSpeech.other.name()));
//									source.append(nextStr);
//									continue;
//								}
//							} else {
//								morphemeResult.add(morphemes[i]);
//							}
//						}
//					} else if (str.indexOf("&#39") > -1 || str.indexOf("&quot") > -1 || str.indexOf("&nbsp") > -1 || str.indexOf("&amp") > -1) {
//						i++;
//						String nextStr = null;
...
//						}
//						if ((i + 2) < length) {
//							nextStr2 = morphemes[i + 2].getWord();
//						}
//						if (nextStr == null) {
//							continue;
//						}
//						if (nextStr.equals(";")) {
//							i++;
//							String tmpStr = str + nextStr;
//							if (ESCAPE_SENTENCE.containsKey(tmpStr)) {
//								String value = ESCAPE_SENTENCE.get(tmpStr);
//								morphemeResult.add(new Morpheme(value, value, PartOfSpeech.other.name()));
//								source.append(value);
//							}
//							if (nextStr2.equals("s")
//									|| nextStr2.equals("d")
//									|| nextStr2.equals("ll")
//									|| nextStr2.equals("ve")
//									|| nextStr2.equals("re")
