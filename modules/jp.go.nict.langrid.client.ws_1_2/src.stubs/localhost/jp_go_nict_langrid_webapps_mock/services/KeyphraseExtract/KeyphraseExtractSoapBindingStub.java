/**
 * KeyphraseExtractSoapBindingStub.java
 *
...
public class KeyphraseExtractSoapBindingStub extends org.apache.axis.client.Stub implements localhost.jp_go_nict_langrid_webapps_mock.services.KeyphraseExtract.KeyphraseExtractService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/KeyphraseExtract", "ArrayOf_tns1_Keyphrase"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.keyphraseextract.Keyphrase[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "extractReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/KeyphraseExtract", "fault"),
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/KeyphraseExtract", "ArrayOf_xsd_string"));
    ...
    public KeyphraseExtractSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public KeyphraseExtractSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public KeyphraseExtractSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/keyphraseextract/", "Keyphrase");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.keyphraseextract.Keyphrase.class;
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/KeyphraseExtract", "ArrayOf_tns1_Keyphrase");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.keyphraseextract.Keyphrase[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/keyphraseextract/", "Keyphrase");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/KeyphraseExtract", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public jp.go.nict.langrid.ws_1_2.keyphraseextract.Keyphrase[] extract(java.lang.String language, java.lang.String text) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.LanguageNotUniquelyDecidedException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.NoValidEndpointsException, jp.go.nict.langrid.ws_1_2.ServiceNotActiveException, jp.go.nict.langrid.ws_1_2.UnsupportedLanguageException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.ServerBusyException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ProcessFailedException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://mock.webapps.langrid.nict.go.jp", "extract"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {language, text});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (jp.go.nict.langrid.ws_1_2.keyphraseextract.Keyphrase[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.keyphraseextract.Keyphrase[]) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.keyphraseextract.Keyphrase[].class);
            }
        }
