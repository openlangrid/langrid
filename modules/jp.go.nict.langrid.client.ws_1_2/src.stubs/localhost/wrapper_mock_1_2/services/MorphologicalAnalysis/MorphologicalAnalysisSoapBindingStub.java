/**
 * MorphologicalAnalysisSoapBindingStub.java
 *
...
public class MorphologicalAnalysisSoapBindingStub extends org.apache.axis.client.Stub implements localhost.wrapper_mock_1_2.services.MorphologicalAnalysis.MorphologicalAnalysis_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/MorphologicalAnalysis", "ArrayOf_tns1_Morpheme"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "analyzeReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/MorphologicalAnalysis", "fault"),
    ...
    public MorphologicalAnalysisSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public MorphologicalAnalysisSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public MorphologicalAnalysisSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/MorphologicalAnalysis", "ArrayOf_tns1_Morpheme");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/morphologicalanalysis/", "Morpheme");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/wrapper-mock-1.2/services/MorphologicalAnalysis", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[] analyze(java.lang.String language, java.lang.String text) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.UnknownException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.LanguageNotUniquelyDecidedException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.ServiceNotActiveException, jp.go.nict.langrid.ws_1_2.UnsupportedLanguageException, jp.go.nict.langrid.ws_1_2.NoValidEndpointsException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.ServerBusyException, jp.go.nict.langrid.ws_1_2.ProcessFailedException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ServiceConfigurationException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://morphologicalanalysis.ws_1_2.wrapper.langrid.nict.go.jp", "analyze"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {language, text});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[]) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class);
            }
        }
