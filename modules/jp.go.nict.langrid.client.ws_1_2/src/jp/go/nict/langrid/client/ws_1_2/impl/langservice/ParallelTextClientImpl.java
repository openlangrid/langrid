/*
 * $Id: ParallelTextClientImpl.java 199 2010-10-02 12:33:18Z t-nakaguchi $
 *
 ...
 */
public class ParallelTextClientImpl  
	extends ServiceClientImpl implements ParallelTextClient
{
	/**
	 * 
	 * 
	 */
	public ParallelTextClientImpl(URL serviceUrl){
		super(serviceUrl);
	}

	public ParallelText[] search(
			Language sourceLang, Language targetLang, String source
			, MatchingMethod matchingMethod
			)
	throws LangridException{
		return (ParallelText[])invoke(
				sourceLang, targetLang, source, matchingMethod
				);
	}

	@Override
	protected Stub createStub(URL url) throws ServiceException {
		ParallelTextServiceLocator locator = new ParallelTextServiceLocator();
		setUpService(locator);
		return (Stub)locator.getParallelText(url);
	}
