/**
 * MorphemesDependencyParserSoapBindingStub.java
 *
...
public class MorphemesDependencyParserSoapBindingStub extends org.apache.axis.client.Stub implements localhost.jp_go_nict_langrid_webapps_mock.services.MorphemesDependencyParser.MorphemesDependencyParserService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("parseDependency");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "language"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "morphs"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/MorphemesDependencyParser", "ArrayOf_tns1_Morpheme"), jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/MorphemesDependencyParser", "ArrayOf_tns2_Chunk"));
        oper.setReturnClass(jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "parseDependencyReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/MorphemesDependencyParser", "fault"),
    ...
    public MorphemesDependencyParserSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public MorphemesDependencyParserSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public MorphemesDependencyParserSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/dependencyparser/", "Chunk");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/dependencyparser/", "Dependency");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.dependencyparser.Dependency.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/MorphemesDependencyParser", "ArrayOf_tns1_Morpheme");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/morphologicalanalysis/", "Morpheme");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/MorphemesDependencyParser", "ArrayOf_tns2_Chunk");
            cachedSerQNames.add(qName);
            cls = jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://langrid.nict.go.jp/ws_1_2/dependencyparser/", "Chunk");
            ...
            qName = new javax.xml.namespace.QName("http://localhost:8080/jp.go.nict.langrid.webapps.mock/services/MorphemesDependencyParser", "ArrayOf_xsd_string");
            cachedSerQNames.add(qName);
    ...
    public jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[] parseDependency(java.lang.String language, jp.go.nict.langrid.ws_1_2.morphologicalanalysis.Morpheme[] morphs) throws java.rmi.RemoteException, jp.go.nict.langrid.ws_1_2.LanguageNotUniquelyDecidedException, jp.go.nict.langrid.ws_1_2.ServiceNotFoundException, jp.go.nict.langrid.ws_1_2.InvalidParameterException, jp.go.nict.langrid.ws_1_2.NoValidEndpointsException, jp.go.nict.langrid.ws_1_2.ServiceNotActiveException, jp.go.nict.langrid.ws_1_2.UnsupportedLanguageException, jp.go.nict.langrid.ws_1_2.AccessLimitExceededException, jp.go.nict.langrid.ws_1_2.ServerBusyException, jp.go.nict.langrid.ws_1_2.NoAccessPermissionException, jp.go.nict.langrid.ws_1_2.ProcessFailedException {
        ...
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://mock.webapps.langrid.nict.go.jp", "parseDependency"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {language, morphs});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[]) org.apache.axis.utils.JavaUtils.convert(_resp, jp.go.nict.langrid.ws_1_2.dependencyparser.Chunk[].class);
            }
        }
