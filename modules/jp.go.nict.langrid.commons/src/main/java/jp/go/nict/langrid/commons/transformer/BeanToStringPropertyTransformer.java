/*
 * $Id: BeanToStringPropertyTransformer.java 182 2010-10-02 03:16:36Z t-nakaguchi $
 *
...
implements Transformer<T, String>{
	 ...
	 * 
	 */
	public BeanToStringPropertyTransformer(
			Class<T> beanClass, String propName)
	...
	public String transform(T value) throws TransformationException {
		try{
			return getter.invoke(value).toString();
