/*
 * $Id: ProxyFormatException.java 192 2010-10-02 11:31:22Z t-nakaguchi $
 *
...
public class ProxyFormatException extends Exception {
	 ...
	 * 
	 */
	public ProxyFormatException(String message){
		super(message);
	}
	 ...
	 * 
	 */
	public ProxyFormatException(Throwable cause){
		super(cause);
	}
	 ...
	 * 
	 */
	public ProxyFormatException(String message, Throwable cause){
		super(message, cause);
	}
