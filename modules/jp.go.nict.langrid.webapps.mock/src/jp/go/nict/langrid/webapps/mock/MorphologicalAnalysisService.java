/*
 * $Id: MorphologicalAnalysisService.java 15143 2011-10-05 01:34:28Z Takao Nakaguchi $
 *
...
implements jp.go.nict.langrid.service_1_2.morphologicalanalysis.MorphologicalAnalysisService{
	@Override
	public jp.go.nict.langrid.service_1_2.morphologicalanalysis.Morpheme[] analyze(
		...
		return new Morpheme[]{new Morpheme(text, text, "other")};
	}
}
