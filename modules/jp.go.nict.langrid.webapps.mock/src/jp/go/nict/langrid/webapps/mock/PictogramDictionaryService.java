/*
 * $Id: PictogramDictionaryService.java 29669 2012-07-25 10:08:51Z nakaguchi $
 *
 ...
 */
public class PictogramDictionaryService
implements jp.go.nict.langrid.service_1_2.pictogramdictionary.PictogramDictionaryService{
	@Override
	public Pictogram[] search(String language, String word,
		...
		return new Pictogram[]{new Pictogram(word, "image/jpeg", "somejpeg".getBytes())};
	}
}
