/*
 * $Id: ParallelTextService.java 15143 2011-10-05 01:34:28Z Takao Nakaguchi $
 *
...
implements jp.go.nict.langrid.service_1_2.paralleltext.ParallelTextService {
	@Override
	public ParallelText[] search(
		...
		return new ParallelText[]{new ParallelText(text, text)};
	}
}
