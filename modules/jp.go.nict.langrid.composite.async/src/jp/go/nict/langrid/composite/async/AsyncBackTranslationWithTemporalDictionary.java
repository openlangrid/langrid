 ...
 */
public class AsyncBackTranslationWithTemporalDictionary
...
implements AsyncBackTranslationWithTemporalDictionaryService{
	...
	throws InvalidParameterException, ProcessFailedException{
		final BackTranslationWithTemporalDictionaryService service = getComponentServiceFactory().getService(
				"BackTranslationWithTemporalDictionaryPL", BackTranslationWithTemporalDictionaryService.class);
		Task<BackTranslationResult> task = new GradualTask<BackTranslationResult>(){
			protected void doWork() throws LangridException {
				for(String source : sources){
					...
					addResult(service.backTranslate(sourceLang, intermediateLang, source, temporalDict, dictTargetLang));
				}
			};
		};
