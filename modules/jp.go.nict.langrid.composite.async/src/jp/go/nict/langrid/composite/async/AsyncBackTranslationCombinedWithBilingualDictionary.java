...
import jp.go.nict.langrid.composite.backtranslation.BackTranslationCombinedWithBilingualDictionary;
 ...
 */
public class AsyncBackTranslationCombinedWithBilingualDictionary
	...
	throws InvalidParameterException, ProcessFailedException{
		Task<BackTranslationResult> task = new GradualTask<BackTranslationResult>(){
			protected void doWork() throws LangridException {
				BackTranslationWithTemporalDictionaryService s = new BackTranslationCombinedWithBilingualDictionary(){
					public ComponentServiceFactory getComponentServiceFactory(){
						return AsyncBackTranslationCombinedWithBilingualDictionary.this.getComponentServiceFactory();
					};
				};
