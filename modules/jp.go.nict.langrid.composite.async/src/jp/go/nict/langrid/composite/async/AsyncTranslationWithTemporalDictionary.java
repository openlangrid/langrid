 ...
 */
public class AsyncTranslationWithTemporalDictionary
...
implements AsyncTranslationWithTemporalDictionaryService{
	...
	throws InvalidParameterException, ProcessFailedException{
		final TranslationWithTemporalDictionaryService service = getComponentServiceFactory().getService(
		...
		Task<String> task = new GradualTask<String>(){
			protected void doWork() throws LangridException {
				for(String source : sources){
					...
					addResult(service.translate(sourceLang, targetLang, source, temporalDict, dictTargetLang));
				}
			};
		};
