 ...
 */
public class AsyncTranslationCombinedWithBilingualDictionary
	...
	throws InvalidParameterException, ProcessFailedException{
		Task<String> task = new GradualTask<String>(){
			protected void doWork() throws LangridException {
				TranslationWithTemporalDictionaryService s = new TranslationCombinedWithBilingualDictionary(){
					public ComponentServiceFactory getComponentServiceFactory(){
						return AsyncTranslationCombinedWithBilingualDictionary.this.getComponentServiceFactory();
					};
				};
