/*
 * $Id: AbstractBackTranslationWithTemporalDictionaryService.java 265 2010-10-03 10:25:32Z t-nakaguchi $
 *
 ...
 */
public abstract class AbstractBackTranslationWithTemporalDictionaryService
...
implements BackTranslationWithTemporalDictionaryService
{
	...
	UnsupportedLanguagePairException
	{
		...
		try{
			...
			return doBackTranslation(s, t, src, dict, dictLang);
	...
	private static Logger logger = Logger.getLogger(
			AbstractBackTranslationWithTemporalDictionaryService.class.getName()
			);
}
