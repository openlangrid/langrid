/*
 * $Id: MonitoringUserLogListPanel.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
...
import jp.go.nict.langrid.management.web.view.page.user.component.list.row.MonitoringUserLogListHeaderPanel;
 ...
 */
public class MonitoringUserLogListPanel
extends AbstractListPanel<IndividualExecutionInformationModel>
{
	/**
	 * 
	 * 
	 */
	public MonitoringUserLogListPanel(String gridId, String componentId
			, IDataProvider<IndividualExecutionInformationModel> provider, Date startDate
			, Date endDate, String organization)
	{
	...
	@Override
	protected void addListItem(String gridId, String rowId, Item<IndividualExecutionInformationModel> item) {
		try{
	...
	protected Panel getHeaderPanel(){
		return new MonitoringUserLogListHeaderPanel("header");
	}
	...
	protected Panel getRowPanel(String gridId
			, Item<IndividualExecutionInformationModel> item, String uniqueId)
