/*
 * $Id: OperationOfAuthorizeRequestedServiceResultPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class OperationOfAuthorizeRequestedServiceResultPage extends LanguageDomainViewPage {
	/**
	 * 
	 * 
	 */
	public OperationOfAuthorizeRequestedServiceResultPage(String serviceId){
	    ...
	    Map<String, String> map = new HashMap<String, String>();
	      try {
	         ...
	         map.put("serviceName", service.get(serviceId).getServiceName());
	      } catch(ServiceManagerException e) {
	         doErrorProcess(e);
	      }
	      add(new Label("message", MessageManager.getMessage(
	         "LanguageGridOperator.message.service.approve.Result", map)));
