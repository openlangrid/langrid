/*
 * $Id: RegistrationOfBpelCompositeServiceResultPage.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
 ...
 */
public class RegistrationOfBpelCompositeServiceResultPage extends ServiceViewPage {
	/**
	 * 
	 * 
	 */
	public RegistrationOfBpelCompositeServiceResultPage(String serviceId){
		try{
			...
			try{
			   add(new MultidirectionalLanguagePathPanel("language", model.getSupportedLanguagePathModel()));
         ...
         InUseListPanel iulp = new ServiceInUseListPanel(gridId, model.getInvocations());
         iulp.makeList();
         add(iulp);
         ...
         Label membership;
         membersCotainer.add(membership = new Label("howToGetMembershipLabel", model.getHowToGetMembershipInfo()));
	...
	private Label getStatusLabel(CompositeServiceModel obj) throws ServiceManagerException{
