/*
 * $Id: MonitoringAllLanguageServiceStatisticPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class MonitoringAllLanguageServiceStatisticPage extends MonitoringLanguageServiceStatisticPage
{
	/**
	 * 
	 * 
	 */
	public MonitoringAllLanguageServiceStatisticPage(
	...
	protected Page getBackPage(){
		return new MonitoringAllLanguageServicePage();
	}
