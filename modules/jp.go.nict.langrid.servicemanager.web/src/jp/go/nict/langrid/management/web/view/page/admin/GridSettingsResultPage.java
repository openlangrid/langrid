/*
 * $Id: GridSettingsResultPage.java 328 2010-12-08 05:43:18Z t-nakaguchi $
 *
 ...
 */
public class GridSettingsResultPage extends ServiceManagerPage{
	/**
	 * 
	 * 
	 */
	public GridSettingsResultPage(int days, RepeatingView repeatingView){
		try {
         add(new Label("commercial", ServiceFactory.getInstance().getGridService().isCommercialUse()
            ...
            : MessageManager.getMessage("LanguageGridOperator.gridSettings.label.useType.commercial.Profibit")));
