/*
 * $Id: RequiredServiceNameField.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class RequiredServiceNameField extends RequiredTextField<String>{
	/**
	 * 
	 * 
	 */
	public RequiredServiceNameField(String componentId, IModel<String> model){
		super(componentId, model);
		addValidator();
	}
	
	public RequiredServiceNameField(String componentId, Component component){
