/*
 * $Id: EditUserProfileUserListAdminPage.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
 ...
 */
public class EditUserProfileUserListAdminPage extends ServiceManagerPage {
	/**
	 * 
	 * 
	 */
	public EditUserProfileUserListAdminPage() {
		try {
		   String gridId = getSelfGridId();
		   UserSortableDataProvider provider = new UserSortableDataProvider(gridId, getSessionUserId());
