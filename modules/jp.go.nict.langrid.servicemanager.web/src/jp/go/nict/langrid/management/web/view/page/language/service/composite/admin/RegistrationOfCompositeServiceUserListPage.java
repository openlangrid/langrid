/*
 * $Id: RegistrationOfCompositeServiceUserListPage.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
...
import jp.go.nict.langrid.management.web.view.page.user.component.list.row.RegistrationOfCompositeServiceUserListAdminRowPanel;
 ...
 */
public class RegistrationOfCompositeServiceUserListPage extends ServiceManagerPage {
	/**
	 * 
	 * 
	 */
	public RegistrationOfCompositeServiceUserListPage() {
		try {
			...
			add(new LanguageUserListPanel(getSelfGridId(), "userListPanel", provider){
				...
				throws ServiceManagerException{
					return new RegistrationOfCompositeServiceUserListAdminRowPanel(
