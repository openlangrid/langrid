/*
 * $Id: ServiceTypeListPanel.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
package jp.go.nict.langrid.management.web.view.page.language.service.admin.type.component.list;
...
import jp.go.nict.langrid.management.web.view.page.language.service.admin.type.component.list.row.ServiceTypeListHeaderPanel;
 ...
 */
public class ServiceTypeListPanel extends AbstractListPanel<ServiceTypeModel>{
	/**
	 * 
	 * 
	 */
	public ServiceTypeListPanel(
			String gridId, String componentId, IDataProvider<ServiceTypeModel> dataProvider)
	{
		super(gridId, componentId, dataProvider);
	}

	protected void addItem(Item<ServiceTypeModel> item){
		//noop
	}
	
	@Override
	protected void addListItem(String gridId, String rowId, Item<ServiceTypeModel> item) {
		Panel row;
		try {
	...
	protected Panel getHeaderPanel(){
		return new ServiceTypeListHeaderPanel("header");
	}
	...
	{
	   return new ServiceTypeListRowPanel(gridId, "row", item.getModelObject(), uniqueId);
	}
