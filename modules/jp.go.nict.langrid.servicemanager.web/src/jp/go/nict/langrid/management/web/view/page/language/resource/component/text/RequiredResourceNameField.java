/*
 * $Id: RequiredResourceNameField.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class RequiredResourceNameField extends RequiredTextField<String>{
	/**
	 * 
	 * 
	 */
	public RequiredResourceNameField(String componentId, IModel<String> model){
		super(componentId, model);
		addValidator();
	}
	
	public RequiredResourceNameField(String componentId, Component component) {
