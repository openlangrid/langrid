/*
 * $Id: RegistrationOfTemporaryUserResultPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 *
 ...
 */
public class RegistrationOfTemporaryUserResultPage extends ServiceManagerPage {
	/**
	 * 
	 * 
	 */
	public RegistrationOfTemporaryUserResultPage(String userId) {
		try {
			TemporaryUserModel entry = ServiceFactory.getInstance().getTemporaryUserService(getSelfGridId(), getSessionUserId()).get(userId);
