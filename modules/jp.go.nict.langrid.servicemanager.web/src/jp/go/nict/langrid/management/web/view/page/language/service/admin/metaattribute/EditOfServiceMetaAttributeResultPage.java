/*
 * $Id: EditOfServiceMetaAttributeResultPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 *
 ...
 */
public class EditOfServiceMetaAttributeResultPage extends ServiceManagerPage{
	/**
	 * 
	 * 
	 */
	public EditOfServiceMetaAttributeResultPage(String domainId, String id){
	      try {
	         ServiceFactory factory = ServiceFactory.getInstance();
	         ServiceMetaAttributeModel model = factory.getServiceMetaAttributeService(
	            getSelfGridId()).get(domainId, id);
	         String domainName = factory.getDomainService(getSelfGridId()).get(domainId).getDomainName();
