/*
 * $Id: CopyrightField.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class CopyrightField extends TextField<String>{
	/**
	 * 
	 * 
	 */
	public CopyrightField(String componentId, IModel<String> model){
