/*
 * $Id: RegistrationOfServiceTypeResultPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 *
 ...
 */
public class RegistrationOfServiceTypeResultPage extends ServiceManagerPage {
	/**
	 * 
	 * 
	 */
	public RegistrationOfServiceTypeResultPage(String domainId, String typeId) {
		try {
			ServiceTypeModel model = ServiceFactory.getInstance().getServiceTypeService(
				getSelfGridId()).get(domainId, typeId);
