/*
 * $Id: FederationTargetSortableDataProvider.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
 ...
 */
public class FederationTargetSortableDataProvider
extends LangridSortableDataProvider<FederationModel> {
	/**
	 * 
	 * 
	 */
	public FederationTargetSortableDataProvider(String gridId, String userId)
	...
	throws ServiceManagerException {
		return ((FederationService)getService()).getAllRelatedTargetGridList(gridId, first, count);
	}

	@Override
	protected int getTotalCount() throws ServiceManagerException {
		return ((FederationService)getService()).getAllRelatedTargetGridListTotalCount(gridId);
	}
