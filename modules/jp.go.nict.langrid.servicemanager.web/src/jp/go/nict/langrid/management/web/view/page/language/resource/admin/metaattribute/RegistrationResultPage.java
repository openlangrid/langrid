/*
 * $Id: RegistrationResultPage.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 *
...
public class RegistrationResultPage extends ServiceManagerPage{
	...
	public RegistrationResultPage(String domainId, String id) {
	   ResourceMetaAttributeModel model;
      try {
         model = ServiceFactory.getInstance().getResourceMetaAttributeService(
