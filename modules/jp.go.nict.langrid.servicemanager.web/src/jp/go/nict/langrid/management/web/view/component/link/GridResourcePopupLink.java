 ...
 */
public abstract class GridResourcePopupLink<T extends Page> extends PopupLink<T>{
	/**
	 * 
	 * 
	 */
	public GridResourcePopupLink(
			String label, String gridId, String id, String uniqueId, Class<T> pageClass){
