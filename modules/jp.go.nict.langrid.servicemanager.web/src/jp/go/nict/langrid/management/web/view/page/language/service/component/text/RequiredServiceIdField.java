/*
 * $Id: RequiredServiceIdField.java 406 2011-08-25 02:12:29Z t-nakaguchi $
 * 
...
import jp.go.nict.langrid.management.web.view.page.language.service.component.form.validator.AlreadyExistsServiceIdValidator;
 ...
 */
public class RequiredServiceIdField extends IdTextField{
	/**
	 * 
	 * 
	 */
   public RequiredServiceIdField(String componentId, String gridId) {
	...
	protected void addValidater(String gridId){
		...
		add(new AlreadyExistsServiceIdValidator(gridId, this));
	}
}
