/*
 * $Id: DescriptionTextAreaField.java 303 2010-12-01 04:21:52Z t-nakaguchi $
 * 
 ...
 */
public class DescriptionTextAreaField extends TextArea<String>{
	/**
	 * 
	 * 
	 */
	public DescriptionTextAreaField(String componentId, String value, boolean isRequired){
		super(componentId, new Model<String>(value));
		setRequired(isRequired);
		addValidator();
	}
	
	public DescriptionTextAreaField(String componentId, boolean isRequired){
