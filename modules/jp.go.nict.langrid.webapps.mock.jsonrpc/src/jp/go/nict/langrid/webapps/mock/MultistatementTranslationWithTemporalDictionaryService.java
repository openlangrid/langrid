 ...
 */
public class MultistatementTranslationWithTemporalDictionaryService
implements jp.go.nict.langrid.service_1_2.translation.MultistatementTranslationWithTemporalDictionaryService{
	@Override
	public String[] multistatementTranslate(
			String sourceLang,
			String targetLangs,
			String[] sources,
			jp.go.nict.langrid.service_1_2.bilingualdictionary.Translation[] temporalDict,
