/*
 * $Id: BilingualDictionaryWithLongestMatchSearchService.java 15143 2011-10-05 01:34:28Z Takao Nakaguchi $
 *
 ...
 */
public class BilingualDictionaryWithLongestMatchSearchService
...
implements jp.go.nict.langrid.service_1_2.bilingualdictionary.BilingualDictionaryWithLongestMatchSearchService{
	...
	public TranslationWithPosition[] searchLongestMatchingTerms(
		...
		return new TranslationWithPosition[]{
				new TranslationWithPosition(new Translation(headLang, new String[]{targetLang}), 0, 1)
		};
	}
}
