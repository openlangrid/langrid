 ...
 */
@Service(namespace="servicegrid:servicetype:nict.nlp:TemplateParallelText")
public interface TemplateParallelTextService {
	/**
	 * 
	 * 
	 */
	Category[] listTemplateCategories(@Parameter(name="language") String language)
	...
	String[] getCategoryNames(
			...
			, @Parameter(name="languages") String[] languages)
	throws AccessLimitExceededException, InvalidParameterException
	, NoAccessPermissionException
	, NoValidEndpointsException, ProcessFailedException
	, ServerBusyException, ServiceNotActiveException
	...
	Template[] getTemplatesByTemplateId(
			@Parameter(name="language") String language
			, @Parameter(name="templateIds") String[] templateIds)
	throws AccessLimitExceededException, InvalidParameterException
		, NoAccessPermissionException
		, NoValidEndpointsException, ProcessFailedException
		, ServerBusyException, ServiceNotActiveException
	...
	String generateSentence(
			@Parameter(name="language") String language
			, @Parameter(name="templateId") String templateId
			, @Parameter(name="boundChoiceParameters") BoundChoiceParameter[] boundChoiceParameters
			, @Parameter(name="boundValueParameters") BoundValueParameter[] boundValueParameters)
	throws AccessLimitExceededException, InvalidParameterException
		, NoAccessPermissionException
		, NoValidEndpointsException, ProcessFailedException
		, ServerBusyException, ServiceNotActiveException
