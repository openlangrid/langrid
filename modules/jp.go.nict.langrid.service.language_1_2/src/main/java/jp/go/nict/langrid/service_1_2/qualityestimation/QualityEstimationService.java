...
/**
 * 
 * Defines the interface for the quality estimation service.
 * If you're providing the quality estimation service, then if you implement this class,
...
public interface QualityEstimationService {
	 ...
	 * @param target String to be translated
	 * @return Quality estimation result
	...
	double estimate(
			...
			, @Parameter(name="target") String target)
	throws LanguagePairNotUniquelyDecidedException, UnsupportedLanguagePairException, InvalidParameterException, ProcessFailedException;
}
