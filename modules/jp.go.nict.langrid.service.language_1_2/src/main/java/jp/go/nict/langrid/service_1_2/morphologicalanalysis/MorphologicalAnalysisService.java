/*
 * $Id: MorphologicalAnalysisService.java 903 2013-07-12 04:29:01Z t-nakaguchi $
 *
...
/**
 * 
 * Defines the interface of the morpheme analysis service.
 * If you're providing the morpheme analysis service, then if you implement this interface, ...
 * You can access it using a client provided by langrid.
 * 
 * @author $Author: t-nakaguchi $
 * @version $Revision: 903 $
 */
@Service(namespace="servicegrid:servicetype:nict.nlp:MorphologicalAnalysis")
public interface MorphologicalAnalysisService
{
	 ...
	 * @return Results of morphemic analysis
