/*
 * $Id: BilingualDictionaryService.java 587 2012-10-19 06:41:14Z t-nakaguchi $
 *
...
public interface BilingualDictionaryService{
	 ...
	 * 
	 */
	@Method(descriptions=@Description("Searches the bilingual dictionary using the specified search term(s) and matching method, and returns bilingual translation."))
	Translation[] search(
			@Parameter(name="headLang", descriptions=@Description("Source language of bilingual translation(RFC3066 compliant)"))
			String headLang
