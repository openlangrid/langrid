...
public class BilingualDictionaryWithLongestMatchSearchProtosUtil {
	public static SearchLongestMatchingTermsRequest buildSearchLongestMatchingTermsRequest(
			List<Header> headers, String headLang, String targetLang
			, List<Morpheme> morphemes){
		return SearchLongestMatchingTermsRequest.newBuilder()
			.addAllHeaders(headers)
			.setHeadLang(headLang)
			.setTargetLang(targetLang)
			.addAllMorphemes(morphemes)
			.build();
	}
}
