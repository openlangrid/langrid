/*
 * $Id: ValidPasswordValidator.java 302 2010-12-01 02:49:42Z t-nakaguchi $
 * 
...
implements ValidatorImpl<ValidPassword, String>{
	/**
	 * 
	 * 
	 */
	public static final String VALID_PATTERN = ".{4,}";

	/**
	 * 
	 * 
	 */
	public void validate(ValidPassword annotation, String value)
	throws ValidationException
	{
		...
		if(!value.matches(VALID_PATTERN)){
			throw new ValidationException("not a valid user id format.");
		}
	}
}
